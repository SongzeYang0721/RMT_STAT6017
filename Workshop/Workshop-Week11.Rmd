...
Our function is similar to solving the quadratic programming problems of the form $$\min \frac{1}{2} x' \Sigma\, x -\mathbb{1}' x$$ with the constraints $\1' x = 1$.
...
with the constraints $A' x \ge b_0$. Here we set $D = \Sigma$, $d=\mathbf{1}$, $A = \mathbf{1}$, $d=0$, and $b_0 = 1$. This means we need to map our problem to this layout.
```{r}
