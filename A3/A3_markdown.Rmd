...
Let's construct a function to simulate the eigenvalues for a number of Fisher matrices. Let's adhere to the traditional assumption that the entries in the F matrix have mean 0 and variance 1.
...
Let's first plot the case of $(75, 100, 200)$ with the number of Fish matrix to be 500.
...
Let's first plot the case of $(25, 100, 200)$ with the number of Fish matrix to be large, say 500.
...
It is clear from the result in part (d) that the first moment of the LSD of Fisher matrix will approach to 1 as $t \rightarrow 0$ and will approach to infinity as $t \rightarrow 1$.
